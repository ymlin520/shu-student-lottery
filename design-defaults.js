...
const vars = [
  ...
  { key: 'mix-speed', group: '抽獎畫面', label: '彩球轉速（0.1 很慢～1 正常）', type: 'range', min: 0.05, max: 1, step: 0.05, default: '0.3' },
  ...
  { key: 'machine-size', group: '抽獎畫面', label: '抽獎機大小（進階公式，平常不用改）', type: 'text', default: 'min(calc(var(--machine-vh, 56) * 1vh), 82vw, 760px)' },
