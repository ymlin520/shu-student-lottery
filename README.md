...
- **＋ 手動新增學生**：現場補登沒有帳號或 SSO 有問題的學生（學號、姓名、系所、Email），會標記「後台補登」。
- **編輯**／**刪除**單筆；**清空名單**會連續確認兩次。
- **匯出 CSV**：UTF-8 with BOM，欄位為報名編號、學號、姓名、系所、Email、來源、報名時間、最後登入、中獎獎項、抽出時間。
...
- **學生密碼只即時轉送給學校認證系統，不寫進 `db.json`，也不寫進任何 log**。存下來的只有學號、姓名、系所、Email 與時間。
